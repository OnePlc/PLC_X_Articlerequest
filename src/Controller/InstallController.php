    ...
    public function checkdbAction()
    {
        ...
        if(! $oRequest->isPost()) {
            ...
            return new ViewModel([
                ...
                'sVendor' => 'oneplace',
                'sModule' => 'oneplace-articlerequest',
            ]);
        } else {
            $sSetupConfig = $oRequest->getPost('plc_module_setup_config');

            $sSetupFile = 'vendor/oneplace/oneplace-articlerequest/data/install.sql';
            ...
            if($sSetupConfig != '') {
                $sConfigStruct = 'vendor/oneplace/oneplace-articlerequest/data/structure_'.$sSetupConfig.'.sql';
                ...
                $sConfigData = 'vendor/oneplace/oneplace-articlerequest/data/data_'.$sSetupConfig.'.sql';
            ...
            $oModTbl->insert([
                'module_key'=>'oneplace-articlerequest',
                'type'=>'module',
                'version'=>\OnePlace\Articlerequest\Module::VERSION,
                'label'=>'onePlace Articlerequest',
                'vendor'=>'oneplace',
            ]);
            ...
            $this->flashMessenger()->addSuccessMessage('Articlerequest DB Update successful');
