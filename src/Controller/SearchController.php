<?php
/**
 * SearchController.php - Articlerequest Search Controller
 *
 * Main Controller for Articlerequest Search
 *
 * @category Controller
...
class SearchController extends CoreSearchController
{
    ...
    /**
     * Dump Articlerequest data to desired format
     *
     * @return bool
     * @since 1.0.0
     */
    public function indexAction() {
         ...
         * Hooks available:
         *
         * articlerequest-search-before (before show search form)
         * articlerequest-search-before-execute (before query)
         * articlerequest-search-after-execute (after query - before show results)
         */
        return $this->generateSearchView('articlerequest');
    }
}