...
class ApiController extends CoreController {
    ...
    public function indexAction() {
        ...
        if(!$this->checkLicense('articlerequest')) {
            $aReturn = ['state'=>'error','message'=>'no valid license for articlerequest found'];
            echo json_encode($aReturn);
            return false;
        }

        $aReturn = ['state'=>'success','message'=>'Welcome to onePlace Articlerequest API'];
        echo json_encode($aReturn);
    ...
    /**
     * List all Entities of Articlerequests
     *
     * @return bool - no View File
     * @since 1.0.0
     */
    public function listAction() {
        ...
        # Get All Articlerequest Entities from Database
    ...
    /**
     * Get a single Entity of Articlerequest
     *
     * @return bool - no View File
     * @since 1.0.0
     */
    public function getAction() {
        ...
        # Get Articlerequest ID from route
        ...
        try {
            ...
            $aReturn = ['state'=>'error','message'=>'Articlerequest not found','oItem'=>[]];
            echo json_encode($aReturn);
            return false;
        }

        # Print Entity
        $aReturn = ['state'=>'success','message'=>'Articlerequest found','oItem'=>$oItem];
        echo json_encode($aReturn);
