<?php
/**
 * ArticlerequestControllerTest.php - Main Controller Test Class
 *
 * Test Class for Main Controller of Articlerequest Module
 *
 * @category Test
...
namespace OnePlaceTest\Articlerequest\Controller;

use OnePlace\Articlerequest\Controller\ArticlerequestController;
...
class ArticlerequestControllerTest extends AbstractHttpControllerTestCase {
    public function setUp() : void {
        ...
        $this->setApplicationConfig([
            ...
            'modules' => ['OnePlace\Articlerequest'],
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/articlerequest', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('articlerequest');
        $this->assertControllerName(ArticlerequestController::class); // as specified in router's controller name alias
        $this->assertControllerClass('ArticlerequestController');
        $this->assertMatchedRouteName('articlerequest');
    }
    ...
    public function testAddActionCanBeAccessed() {
        ...
        $this->dispatch('/articlerequest/add', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('articlerequest');
        $this->assertControllerName(ArticlerequestController::class); // as specified in router's controller name alias
        $this->assertControllerClass('ArticlerequestController');
    ...
    public function testEditActionCanBeAccessed() {
        ...
        $this->dispatch('/articlerequest/edit/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('articlerequest');
        $this->assertControllerName(ArticlerequestController::class); // as specified in router's controller name alias
        $this->assertControllerClass('ArticlerequestController');
    ...
    public function testViewActionCanBeAccessed() {
        ...
        $this->dispatch('/articlerequest/view/1', 'GET');
        $this->assertResponseStatusCode(200);
        $this->assertModuleName('articlerequest');
        $this->assertControllerName(ArticlerequestController::class); // as specified in router's controller name alias
        $this->assertControllerClass('ArticlerequestController');
