...
use OnePlace\Articlerequest\Controller\ApiController;
...
class ApiControllerTest extends AbstractHttpControllerTestCase {
    ...
    public function testIndexActionCannotBeAccessedWithoutKey() {
        $this->dispatch('/articlerequest/api', 'GET');
    ...
    public function testIndexActionCanBeAccessed() {
        ...
        $this->dispatch('/articlerequest/api?authkey=DEVRANDOMKEY', 'GET');
        ...
        $this->assertMatchedRouteName('articlerequest-api');
    }
}
